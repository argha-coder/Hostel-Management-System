...
import { Mail, Lock, ArrowRight, Shield, ShieldCheck, Sparkles, ChevronRight, CheckCircle2, ShieldAlert } from 'lucide-react';
...
const Login = () => {
  ...
  const handleLoginSubmit = async (e) => {
    ...
    try {
      ...
      if (data.role) { dispatch(setCredentials(data)); navigate('/dashboard'); }
      else setStep(2);
    } catch (err) {
    ...
    <div className="min-h-screen bg-slate-50 flex font-sans overflow-hidden">
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-indigo-600 relative overflow-hidden items-center justify-center p-20">
         ...
         <div className="relative z-10 text-white max-w-lg">
            ...
            >
              The Next Gen<br />Hostel Experience.
            </motion.h1>
            <motion.p 
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
            ...
            >
              Experience seamless room bookings, instant gate pass approvals, and gourmet canteen services at your fingertips.
            </motion.p>
            
            <div className="space-y-4">
               {['Automated Room Allotment', 'Paperless Gate Pass System', 'Smart E-Canteen POS'].map((feat, i) => (
                 <motion.div 
                  key={i}
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-8 md:p-20 relative">
         ...
         <div className="w-full max-w-md relative z-10">
            ...
            <AnimatePresence mode="wait">
               {step === 1 ? (
                 ...
                 >
                    ...
                    <div className="space-y-2">
                       <div className="flex justify-between items-center px-1">
                          ...
                          <Link to="/forgot-password" className="text-xs font-bold text-indigo-600 hover:text-indigo-700 transition-colors">Forgot?</Link>
                       </div>
                       <div className="relative group">
                 ...
                 >
                    ...
                    <h3 className="text-2xl font-black text-slate-900 tracking-tight">Security Check</h3>
            ...
            <div className="mt-12 pt-8 border-t border-slate-100 text-center">
               <p className="text-slate-500 font-medium">New here? <Link to="/register" className="text-indigo-600 font-black hover:text-indigo-700 underline-offset-4 hover:underline transition-all">Create an account</Link></p>
            </div>
         </div>
      </div>
    </div>
