    ...
    <div style={{ width: '100%', height: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
      ...
      >
        <div style={{ textAlign: 'center', marginBottom: '30px' }}>
          ...
          <p style={{ color: 'var(--color-text-muted)', fontSize: '0.9rem', marginTop: '5px' }}>Hostel Management</p>
        </div>
        ...
        <div style={{ marginTop: '30px', textAlign: 'center' }}>
          <p style={{ color: 'var(--color-text-muted)', fontSize: '0.85rem' }}>
            Don't have an account? <Link to="/register" style={{ color: 'var(--color-accent)', textDecoration: 'none', fontWeight: 500 }}>Register</Link>
          </p>
        </div>
      </motion.div>
    </div>
